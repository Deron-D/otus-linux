...
#opt/1C/v8.3/x86_64/rac infobase --cluster=$CLUSTER_UUID drop --infobase=$BASE_UUID --infobase-user=$infobase_user
...
/opt/1C/v8.3/x86_64/rac infobase info --cluster=$CLUSTER_UUID --infobase=$BASE_UUID --infobase-user=$infobase_user
