...
LABEL linux-http-install
  menu label ^Install system from http
  menu default
  kernel images/CentOS-8/vmlinuz
  append initrd=images/CentOS-8/initrd.img ip=enp0s3:dhcp inst.repo=http://10.0.0.20/centos8-install/ inst.stage2=http://10.0.0.20/install.img
LABEL linux-auto
  menu label ^Auto install system
  kernel images/CentOS-8/vmlinuz
  append initrd=images/CentOS-8/initrd.img ip=enp0s3:dhcp inst.ks=nfs:10.0.0.20:/home/vagrant/cfg/ks.cfg inst.repo=http://10.0.0.20/centos8-autoinstall
LABEL vesa
...
curl http://mirror.yandex.ru/centos/8/BaseOS/x86_64/os/images/pxeboot/initrd.img -o /var/lib/tftpboot/pxelinux/images/CentOS-8/initrd.img
curl http://mirror.yandex.ru/centos/8/BaseOS/x86_64/os/images/pxeboot/vmlinuz -o /var/lib/tftpboot/pxelinux/images/CentOS-8/vmlinuz
...
#curl -O http://mirror.yandex.ru/centos/8.3.2011/BaseOS/x86_64/os/images/boot.iso
curl -O http://mirror.yandex.ru/centos/8/BaseOS/x86_64/os/images/boot.iso
...
curl http://mirror.yandex.ru/centos/8/BaseOS/x86_64/os/images/install.img -o /var/www/html/install.img
